...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MOPRO_BINDINGS_FN_FUNC_SEMAPHORE_VERIFY
#define UNIFFI_FFIDEF_UNIFFI_MOPRO_BINDINGS_FN_FUNC_SEMAPHORE_VERIFY
int8_t uniffi_mopro_bindings_fn_func_semaphore_verify(RustBuffer proof, RustCallStatus *_Nonnull out_status
);
#endif
...
#define UNIFFI_FFIDEF_UNIFFI_MOPRO_BINDINGS_CHECKSUM_FUNC_SEMAPHORE_PROVE
uint16_t uniffi_mopro_bindings_checksum_func_semaphore_prove(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MOPRO_BINDINGS_CHECKSUM_FUNC_SEMAPHORE_VERIFY
#define UNIFFI_FFIDEF_UNIFFI_MOPRO_BINDINGS_CHECKSUM_FUNC_SEMAPHORE_VERIFY
uint16_t uniffi_mopro_bindings_checksum_func_semaphore_verify(void
