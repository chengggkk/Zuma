...
public struct FfiConverterTypeG1: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> G1 {
        return
            try G1(
                ...
                z: FfiConverterOptionString.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: G1, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionString.write(value.z, into: &buf)
    }
}
...
public struct FfiConverterTypeG2: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> G2 {
        return
            try G2(
                ...
                z: FfiConverterOptionSequenceString.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: G2, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionSequenceString.write(value.z, into: &buf)
    }
}
...
public struct ProofResult {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(inputs: String, proof: String) {
        self.inputs = inputs
        self.proof = proof
    }
}
...
public func semaphoreProve(idSecret: String, leaves: [String], signal: String, externalNullifier: String) -> ProofResult  {
    ...
    uniffi_mopro_bindings_fn_func_semaphore_prove(
        ...
        FfiConverterString.lower(externalNullifier),$0
    )
})
}
public func semaphoreVerify(proof: ProofResult) -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_mopro_bindings_fn_func_semaphore_verify(
        FfiConverterTypeProofResult_lower(proof),$0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mopro_bindings_checksum_func_semaphore_verify() != 29222) {
        return InitializationResult.apiChecksumMismatch
    }
