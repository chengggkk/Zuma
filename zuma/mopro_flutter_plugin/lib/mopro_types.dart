...
class SemaphoreProveResult {
  final String proof;
  final String inputs;

  SemaphoreProveResult(this.proof, this.inputs);

  factory SemaphoreProveResult.fromMap(Map<Object?, Object?> proofResult) {
    var proof = proofResult["proof"] as String;
    var inputs = proofResult["inputs"] as String;
    return SemaphoreProveResult(proof, inputs);
  }
}
