...
internal interface UniffiLib : Library {
    ...
    fun uniffi_mopro_bindings_fn_func_semaphore_prove(
        ...
        `signal`: RustBuffer.ByValue,
        `externalNullifier`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_mopro_bindings_fn_func_semaphore_verify(
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_mopro_bindings_checksum_func_semaphore_verify() != 29222.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public object FfiConverterTypeG1 : FfiConverterRustBuffer<G1> {
    ...
    override fun allocationSize(value: G1) =
        (
            FfiConverterString.allocationSize(value.`x`) +
                ...
                FfiConverterOptionalString.allocationSize(value.`z`)
        )
    ...
    override fun write(
        ...
        FfiConverterOptionalString.write(value.`z`, buf)
    }
}
...
public object FfiConverterTypeG2 : FfiConverterRustBuffer<G2> {
    ...
    override fun allocationSize(value: G2) =
        (
            FfiConverterSequenceString.allocationSize(value.`x`) +
                ...
                FfiConverterOptionalSequenceString.allocationSize(value.`z`)
        )
    ...
    override fun write(
        ...
        FfiConverterOptionalSequenceString.write(value.`z`, buf)
    }
}
...
public object FfiConverterTypeProofResult : FfiConverterRustBuffer<ProofResult> {
    ...
    override fun allocationSize(value: ProofResult) =
        (
            FfiConverterString.allocationSize(value.`inputs`) +
    ...
    override fun write(
        ...
        FfiConverterString.write(value.`inputs`, buf)
...
fun `semaphoreProve`(
    ...
    `leaves`: List<kotlin.String>,
    `signal`: kotlin.String,
    `externalNullifier`: kotlin.String,
): ProofResult =
    FfiConverterTypeProofResult.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_bindings_fn_func_semaphore_prove(
                FfiConverterString.lower(`idSecret`),
                FfiConverterSequenceString.lower(`leaves`),
                FfiConverterString.lower(`signal`),
                FfiConverterString.lower(`externalNullifier`),
                _status,
            )
        },
    )

fun `semaphoreVerify`(`proof`: ProofResult): kotlin.Boolean =
    FfiConverterBoolean.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_bindings_fn_func_semaphore_verify(
                FfiConverterTypeProofResult.lower(`proof`),
                _status,
            )
        },
    )
